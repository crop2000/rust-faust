...
impl Amplifer {
    ...
    pub fn metadata(&self, m: &mut dyn Meta) {
        ...
        m.declare(
            "compile_options",
            r"-lang rust -ec -ct 1 -cn Amplifer -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0",
        );
    ...
    pub fn control(&mut self) {
        self.fSlow0 = self.fConst2 * F64::powf(1e+01, 0.05 * self.fVslider0);
        self.fSlow1 = self.fConst2 * F64::powf(1e+01, 0.05 * self.fVslider1);
    }
    pub fn compute(
        &mut self,
        count: usize,
        ...
        for (((input0, input1), output0), output1) in zipped_iterators {
            self.fRec1[0] = self.fSlow0 + self.fConst3 * self.fRec1[1];
            ...
            *output0 = (self.iConst4) as F64;
            self.fRec3[0] = self.fSlow1 + self.fConst3 * self.fRec3[1];
