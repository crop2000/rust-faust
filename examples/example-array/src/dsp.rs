...
Compilation options: -a /tmp/.tmpWub3Kg -lang rust -ct 1 -cn Volume -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
pub mod dsp {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
    ...
    impl FaustDsp for Volume {
        ...
        fn metadata(&self, m: &mut dyn Meta) {
            ...
            m.declare("compile_options", r"-a /tmp/.tmpWub3Kg -lang rust -ct 1 -cn Volume -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
