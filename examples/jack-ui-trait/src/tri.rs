...
impl TriSIG0 {
    fn get_num_inputsTriSIG0(&self) -> i32 {
        return 0;
    }
    fn get_num_outputsTriSIG0(&self) -> i32 {
        return 1;
    }
    pub fn instance_initTriSIG0(&mut self, sample_rate: i32) {
        for l0 in 0..2 {
    ...
    pub fn fillTriSIG0(&mut self, count: i32, table: &mut [FaustFloat]) {
        for i1 in 0..count {
            self.iVec0[0] = 1;
    ...
    const fn static_init() -> LazyCell<[f32; 65536]> {
        LazyCell::new(|| {
            let mut sig: [F32; 65536] = [0.0; 65536];
            let mut sig0: TriSIG0 = TriSIG0::newTriSIG0();
            sig0.instance_initTriSIG0(-1);
            sig0.fillTriSIG0(65536, &mut sig);
            sig
        })
    }
    pub fn newTriSIG0() -> TriSIG0 {
        TriSIG0 {
            iVec0: [0; 2],
            iRec0: [0; 2],
        }
...
static mut ftbl0TriSIG0: LazyCell<[F32; 65536]> = TriSIG0::static_init();
...
impl Tri {
    ...
    pub fn metadata(&self, m: &mut dyn Meta) {
        ...
        m.declare(
            "compile_options",
            r"-lang rust -cm -ct 1 -cn Tri -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0",
        );
        m.declare("copyright", r"(c)GRAME 2009");
        m.declare("filename", r"tri.dsp");
    ...
    pub fn class_init(sample_rate: i32) {
        // let mut sig0: TriSIG0 = newTriSIG0();
        // sig0.instance_initTriSIG0(sample_rate);
        // sig0.fillTriSIG0(65536, unsafe { &mut ftbl0TriSIG0 });
    }
...
impl FaustFloatDsp for Tri {
    type F = FaustFloat;
}
impl UIEnumsDsp for Tri {
    type DA = UIActive;
...
impl UISet for UIActive {
    type D = Tri;
    fn set(&self, dsp: &mut Tri, value: <Self::D as FaustFloatDsp>::F) {
        match self {
...
impl UIGet for UIPassive {
    ...
    fn get_enum(&self, dsp: &Tri) -> <Self::D as UIEnumsDsp>::EP {
        panic!("cannot be called")
    }
}
impl UIPassive {
...
pub mod meta {
    ...
    pub const COMPILE_OPTIONS: &'static str =
        "-lang rust -cm -ct 1 -cn Tri -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0";
    pub const COPYRIGHT: &'static str = "(c)GRAME 2009";
    pub const FILENAME: &'static str = "tri.dsp";
    pub const LICENSE: &'static str = "BSD";
    pub const NAME: &'static str = "tri";
