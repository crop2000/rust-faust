...
// i guess a too radical summary
pub fn fillTriSIG0() -> [F32; 65536] {
    let mut iVec0: [i32; 2] = [0; 2];
    let mut iRec0: [i32; 2] = [0; 2];
    let mut table: [FaustFloat; 65536] = core::array::from_fn(|i| {
        iVec0[0] = 1;
        iRec0[0] = (i32::wrapping_add(iVec0[1], iRec0[1])) % 65536;
        let r = F32::sin(9.58738e-05 * (iRec0[0]) as F32);
        iVec0[1] = iVec0[0];
        iRec0[1] = iRec0[0];
        r
    });
...
static mut ftbl0TriSIG0: LazyLock<[f32; 65536]> = LazyLock::new(fillTriSIG0);
mod ffi {
