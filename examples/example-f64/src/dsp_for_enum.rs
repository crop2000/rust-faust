...
Compilation options: -a /tmp/.tmpX4nzXp -lang rust -ct 1 -cn Volume -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -double -ftz 0
------------------------------------------------------------ */
pub mod dsp {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
    ...
    pub enum ParamIn_mydsp {
        volume = 1,
        test(f32),
    }

    pub enum ParamOut_mydsp {
        level = 0,
    }
    ...
    impl Volume {
        ...
        pub fn metadata(&self, m: &mut dyn Meta) {
            ...
            m.declare("compile_options", r"-a /tmp/.tmpX4nzXp -lang rust -ct 1 -cn Volume -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -double -ftz 0");
        ...
        //make use of old implementation to keep change small for now
        pub fn set_param_in(&mut self, param: ParamIn_mydsp, value: FaustFloat) {
            self.set_param(ParamIndex(param as i32), value)
        }

        pub fn get_param_out(&self, param: ParamOut_mydsp) -> Option<FaustFloat> {
            self.get_param(ParamIndex(param as i32))
        }
