...
Compilation options: -a /tmp/.tmpD1pfP7 -lang rust -ct 1 -cn Volume -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */
pub mod dsp {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
    ...
    impl Volume {
        ...
        pub fn metadata(&self, m: &mut dyn Meta) {
            ...
            m.declare("compile_options", r"-a /tmp/.tmpD1pfP7 -lang rust -ct 1 -cn Volume -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
    ...
    impl Volume {
        pub fn get_param_enum(&self, param: UIEnum) -> FaustFloat {
            match param {
                UIEnum::channel_0(channel_0::Level) => self.fVbargraph0,
                UIEnum::channel_1(channel_1::Level) => self.fVbargraph1,
                UIEnum::channel_0(channel_0::Volume) => self.fVslider0,
                UIEnum::channel_1(channel_1::Volume) => self.fVslider1,
            }
        }

        pub fn set_param_enum(&mut self, param: UIEnum, value: FaustFloat) {
            match param {
                UIEnum::channel_0(channel_0::Level) => self.fVbargraph0 = value,
