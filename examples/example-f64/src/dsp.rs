...
Compilation options: -a /tmp/.tmpDJQxve -lang rust -ct 1 -cn Volume -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
pub mod dsp {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
    ...
    impl FaustDsp for Volume {
        ...
        fn metadata(&self, m: &mut dyn Meta) {
            ...
            m.declare("compile_options", r"-a /tmp/.tmpDJQxve -lang rust -ct 1 -cn Volume -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
        ...
        type O<'a> = &'a mut [&'a mut [f32]; 2];
        fn compute<'a>(
            &mut self,
            count: i32,
            inputs: &'a [&'a [Self::T]; 2],
            outputs: &'a mut [&'a mut [f32]; 2],
        ) {
