...
Compilation options: -a /tmp/.tmpmFIjK1 -lang rust -ct 1 -cn VolumeControl -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -double -ftz 0
------------------------------------------------------------ */
pub mod dsp {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
    ...
    impl VolumeControl {
        pub fn metadata(&self, m: &mut dyn Meta) {
            ...
            m.declare("compile_options", r"-a /tmp/.tmpmFIjK1 -lang rust -ct 1 -cn VolumeControl -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -double -ftz 0");
        ...
        pub fn build_user_interface_static(ui_interface: &mut dyn UI<FaustFloat>) {
            ...
            ui_interface.open_vertical_box("left");
            ui_interface.declare(Some(ParamIndex(0)), "1", "");
            ui_interface.add_vertical_slider("volume", ParamIndex(0), 0.0, -7e+01, 4.0, 0.1);
            ui_interface.close_box();
            ui_interface.declare(Some(ParamIndex(1)), "2", "");
            ui_interface.declare(Some(ParamIndex(1)), "style", "dB");
            ui_interface.declare(Some(ParamIndex(1)), "unit", "dB");
            ui_interface.add_vertical_bargraph("level", ParamIndex(1), -6e+01, 5.0);
            ui_interface.open_vertical_box("right");
            ui_interface.declare(Some(ParamIndex(2)), "2", "");
            ui_interface.add_vertical_slider("volume", ParamIndex(2), 0.0, -7e+01, 4.0, 0.1);
            ui_interface.close_box();
            ui_interface.close_box();
        }
        ...
        pub fn get_param(&self, param: ParamIndex) -> Option<FaustFloat> {
            match param.0 {
                1 => Some(self.fVbargraph0),
                0 => Some(self.fVslider0),
                2 => Some(self.fVslider1),
                _ => None,
            }
        }
        ...
        pub fn set_param(&mut self, param: ParamIndex, value: FaustFloat) {
            match param.0 {
                1 => self.fVbargraph0 = value,
                0 => self.fVslider0 = value,
                2 => self.fVslider1 = value,
                _ => {}
            }
        }
        ...
        pub fn compute_arrays(
            ...
            let mut fSlow1: F64 = self.fConst1 * F64::powf(1e+01, 0.05 * self.fVslider1);
            ...
            for (((input0, input1), output0), output1) in zipped_iterators {
                ...
                let mut fTemp1: F64 = *input1 * self.fRec2[0];
                self.fRec1[0] = F64::max(
                    self.fRec1[1] - self.fConst3,
                    F64::abs(0.5 * (fTemp0 + fTemp1)),
                );
    ...
    impl HasMeta for VolumeControl {
        fn metadata(&self, m: &mut dyn Meta) {
            self.metadata(m)
        }
    }

    impl HasParam for VolumeControl {
        type T = FaustFloat;
    ...
    impl HasCompute for VolumeControl {
        type T = FaustFloat;
