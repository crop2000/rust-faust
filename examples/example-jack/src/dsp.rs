...
Compilation options: -a /tmp/.tmpDZW4uF -lang rust -ct 1 -cn JVolume -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
use faust_types::*;
...
impl JVolume {
	...
	pub fn compute_arrays(&mut self, count: i32, inputs: &[&[F32] ; 2], outputs: &mut [&mut [F32] ; 2]) {
	...
	pub fn metadata(&self, m: &mut dyn Meta) { 
		...
		m.declare("compile_options", r"-a /tmp/.tmpDZW4uF -lang rust -ct 1 -cn JVolume -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
