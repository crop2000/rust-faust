...
Compilation options: -a /tmp/.tmpdA1RzZ -lang rust -ct 1 -cn JVolume -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
pub mod dsp_volume {
    #![allow(clippy::all)]
    #![allow(unused_parens)]
...
impl JVolume {
	...
	pub fn metadata(&self, m: &mut dyn Meta) { 
		...
		m.declare("compile_options", r"-a /tmp/.tmpdA1RzZ -lang rust -ct 1 -cn JVolume -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
